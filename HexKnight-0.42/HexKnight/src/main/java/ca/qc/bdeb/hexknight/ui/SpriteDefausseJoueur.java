...
class SpriteDefausseJoueur extends Sprite {
    
    private final Joueur leJoueur;

    public SpriteDefausseJoueur(BufferedImage image, Joueur unJoueur) {
        super(image);
    ...
    public void paintComponent(Graphics g) {
        ...
        String taillePaquet = Integer.toString(leJoueur.getTailleDefausse());
