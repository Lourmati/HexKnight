...
public class DessinateurAjout implements DessinateurElementTuile {

    @Override
    public void dessinerElement(Graphics2D g2d, TuileJeu tuile, FormeAbstraite forme) {
        TypeAjoutTuile feature = tuile.getAjout();
        BufferedImage image = RepertoireImages.getImageFeature(feature);
